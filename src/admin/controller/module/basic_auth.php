...
namespace Opencart\Admin\Controller\Extension\BasicAuth\Module;
class BasicAuth extends \Opencart\System\Engine\Controller {

	private $_route 	= 'extension/basic_auth/module/basic_auth';
	private $_model 	= 'model_extension_basic_auth_module_basic_auth';
	...
	protected function validate() {
		...
		if ((mb_strlen($this->request->post['basic_auth_htpasswd_path']) <= 0) || (mb_strlen($this->request->post['basic_auth_htpasswd_path']) > 255)) {
